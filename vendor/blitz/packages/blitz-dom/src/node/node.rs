        ...
        match &self.data {
            ...
            NodeData::Element(data) => {
                ...
                for attr in data.attrs() {
                    ...
                    writer.push_str("=\"");
                    // Keep authored attributes intact. In particular, usvg must
                    // resolve currentColor using its SVG CSS/presentation cascade;
                    // replacing it with Stylo's color here loses SVG-local overrides.
