use makepad_html::{
    MAX_HTML_BYTES, MAX_OUTPUT_PIXELS, RenderError, RenderOptions, ResourceMap, render_html,
};
fn render(html: &str) -> makepad_html::RenderedDocument {
    render_html(
        html,
        RenderOptions {
            width_css: 200,
...
fn pixel(image: &makepad_html::RenderedDocument, x: usize, y: usize) -> &[u8] {
