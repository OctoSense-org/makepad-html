...
pub enum RenderError {
    #[error("HTML input exceeds {MAX_HTML_BYTES} bytes")]
    InputTooLarge,
    #[error("HTML exceeds token or nesting limits")]
    DocumentTooComplex,
...
pub struct RenderOptions {
    ...
    pub width_css: u32,
    /// Initial layout viewport height; controls vh units, not the document crop.
    pub viewport_height_css: u32,
    /// Output maximum height in CSS pixels. Longer documents report `clipped`.
